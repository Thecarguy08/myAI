...
export const CHAT_HEADER: string = `Welcome to Culture Catalyst`;
export const MESSAGE_PLACEHOLDER: string = `[MESSAGE PLACEHOLDER]`;
export const FOOTER_MESSAGE: string = `Made with love by Conner W. @ UNC`;
export const CLEAR_BUTTON_TEXT: string = `Clear Text :)`;
export const PAGE_TITLE: string = `CultureCatalyst`;
